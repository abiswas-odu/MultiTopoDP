Graph.exe: main.o dirFile.o SequenceNode.o StickNode.o Geometry.o Residue.o Atom.o Point.o Ultility.o GraphNode.o Set.o Path.o Vectors.o MRC.o Record.o Graph.o
	icpc -O -o Graph.exe GraphUpdate4/dirFile.o GraphUpdate4/SequenceNode.o GraphUpdate4/StickNode.o GraphUpdate4/Geometry.o GraphUpdate4/Residue.o GraphUpdate4/Atom.o GraphUpdate4/Point.o GraphUpdate4/Ultility.o GraphUpdate4/GraphNode.o GraphUpdate4/Set.o GraphUpdate4/Path.o GraphUpdate4/Vectors.o GraphUpdate4/MRC.o GraphUpdate4/Record.o GraphUpdate4/Graph.o GraphUpdate4/main.o 
...
clean:
	rm -rf *~ ./other GraphUpdate4/*.o Graph.exe
